...
public abstract class StatsDClientTest<T extends StatsDClient> {

    protected static final String STATSD_SERVER_HOST = "localhost";
    protected static final int STATSD_SERVER_PORT = 17254;
    
    private DummyStatsDServer server;
    
    public T buildClient(String prefix) {
        return buildClient(prefix, null);
    }
    
    abstract public T buildClient(String prefix, String[] constantTags);

    private final T client = buildClient("my.prefix");
    ...
    sends_gauge_mixed_tags() throws Exception {
        ...
        final T empty_prefix_client = buildClient("my.prefix", new String[] {"instance:foo", "app:bar"});
    ...
    sends_gauge_empty_prefix() throws Exception {
        ...
        final T empty_prefix_client = buildClient("");
    ...
    sends_gauge_null_prefix() throws Exception {
        ...
        final T null_prefix_client = buildClient(null);
