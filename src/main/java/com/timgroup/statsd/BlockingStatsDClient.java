...
public class BlockingStatsDClient implements StatsDClient {
     ...
     *     if the client could not be started
     */
    public BlockingStatsDClient(final String prefix, final String hostname, final int port, final String[] constantTags,
     ...
     * @see BlockingStatsDClient#BlockingStatsDClient(String, String[], StatsDClientErrorHandler, Callable)
     */
